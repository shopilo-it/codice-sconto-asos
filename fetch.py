#!/usr/bin/env python3
"""
Recupero codici sconto ASOS da shopilo.it
Sursa: https://shopilo.it/negozi/asos.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/asos.com"
STORE_NAME = "ASOS"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per ASOS da shopilo.it"""
    headers = {
